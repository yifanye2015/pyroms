...
# This script updates gridid.txt with a relative path so overall directory structure should not be changed!
# Specifically gridid_txt = os.path.join(script_dir, '../../pyroms/pyroms/gridid.txt')
