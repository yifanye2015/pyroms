...
mkdir -p "merra2_opendap_processing/Forcings/INT"
mkdir -p "merra2_opendap_processing/Forcings/RAD"
mkdir -p "merra2_opendap_processing/Forcings/SLV"
...
mkdir -p "output_files/merra2_opendap_files/Forcings"

echo "New project created at: $script_dir/$PROJ_NAME"
echo "Remember to update .env with your Earthdata credentials for merra2 processing, or ~/.netrc for merra2 opendap processing."