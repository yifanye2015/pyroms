...
url='http://tds.hycom.org/thredds/dodsC/datasets/GLBy0.08/expt_93.0/data/hindcasts/2019/hycom_glby_930_2019010112_t000_uv3z.nc'
...
for month in range(5,5+1):
    ...
    for day in range(1,1+1): # range excludes upper bound, if using all days of the month then use range(1,daysinmonth[month]+1)
        ...
        url='http://tds.hycom.org/thredds/dodsC/datasets/GLBy0.08/expt_93.0/data/hindcasts/'+ year_tag +'/hycom_glby_930_' + date_tag + '12_t000_uv3z.nc' # Changed URL according to previous url
