...
src_grd = pyroms_toolbox.Grid_HYCOM.get_nc_Grid_HYCOM('/home/yeyifan/pyroms/Palau_HYCOM/HYCOM_GLBy0.08_penang_grid.nc')
dst_grd = pyroms.grid.get_ROMS_grid('PENANG')
