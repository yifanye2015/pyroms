...
# lon = dataset.variables['lon'][1253-1:1300+1] # this is not a mistake
# repetitions_lon = len(dataset.variables['lat'][2136-1:2140+1]) # this is not a mistake
# lon = np.tile(lon,(repetitions_lon,1))
# lon = np.asarray(lon)

# lat = dataset.variables['lat'][2136-1:2140+1]
# repetitions_lat = len(dataset.variables['lon'][1253-1:1300+1]) # this is not a mistake
# lat = np.transpose([lat]*repetitions_lat)

#consider using this next time
lon = dataset.variables['lon'][1253-1:1300+1]
lat = dataset.variables['lat'][2136-1:2140+1]
...
var = dataset.variables[invarname][0,:,2136-1:2140+1,1253-1:1300+1]
...
#create netCDF file
outfile = 'HYCOM_GLBy0.08_penang_grid.nc'
